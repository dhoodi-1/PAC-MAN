...
import java.lang.Math;
    ...
    class GamePanel extends JPanel{
        ...
        //private ArrayList<Pacman> pacman = new ArrayList<Pacman>();
        ...
        public GamePanel(HomePanel a, HomeScreen HomeScreen){
           ...
           animationObjects = new ArrayList<Animatable>();
            ...
            t = new Timer(1, new AnimationListener());
            t.start();
        ...
        public void drawMap(Graphics g){
            ...
            for(int x = 675; x<=750; x +=25){
                Pellet pp = new Pellet(x,125);
                pp.drawMe(g);
                p.add(pp);
            }

            Pellet pp = new Pellet(175, 300);
            pp.drawMe(g);
            p.add(pp);
            Pellet ppa = new Pellet(625, 300);
            ppa.drawMe(g);
            p.add(ppa);
